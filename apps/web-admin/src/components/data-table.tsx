...
>(props: DataTableColumnProps<RecordType>) {
  ...
  // Don't render source value if we have children, render, or field
  const shouldRenderSource = !children && !render && !field && source;
...
// Attach Column to DataTable for convenience
