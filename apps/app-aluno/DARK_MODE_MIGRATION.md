...
Este documento explica como aplicar os tokens do Figma (Dark Mode) em todos os componentes do app-aluno.
...
- `colors.background.brandPrimary` - Verde BORA (#00C853)
- `colors.background.brandSecondary` - Verde BORA secundário (#00A844)
...
- `colors.border.brand` - Borda brand (#00C853)
...
### Prioridade Alta
- [x] `app/screens/lessonChat.tsx` ✅
- [x] `app/(tabs)/index.tsx` ✅
- [x] `app/(tabs)/search.tsx` ✅
- [x] `app/(tabs)/lessons.tsx` ✅
- [x] `app/(tabs)/profile.tsx` ✅
- [x] `app/(tabs)/_layout.tsx` ✅
- [x] `app/screens/SolicitarAulaFlow.tsx` ✅
- [x] `app/screens/steps/StepDateTime.tsx` ✅
- [x] `app/screens/steps/StepLessonType.tsx` ✅
- [x] `app/screens/steps/StepVehicle.tsx` ✅
- [x] `app/screens/steps/StepPlan.tsx` ✅
- [x] `app/screens/steps/StepPayment.tsx` ✅
- [x] `app/screens/steps/StepConfirm.tsx` ✅

### Prioridade Média
- [x] `app/screens/wallet.tsx` ✅
- [ ] `app/screens/bundles.tsx`
- [ ] `app/screens/pixPayment.tsx`
- [ ] `app/screens/rating.tsx`
- [ ] `app/screens/lessonLive.tsx`

### Prioridade Baixa
- [ ] `app/screens/myProgress.tsx`
- [ ] `app/screens/skillDetail.tsx`
- [ ] `app/screens/myBundles.tsx`
- [ ] `app/screens/bundlePayment.tsx`
- [ ] `app/screens/paymentSheet.tsx`
- [ ] Outros componentes...

## 🎯 Exemplo Completo

Veja `app/screens/lessonChat.tsx` como referência de migração completa.
