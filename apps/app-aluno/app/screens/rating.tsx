...
export default function RatingScreen() {
      ...
      <View style={styles.container}>
        <View style={styles.alreadyRatedContainer}>
          ...
          <Text style={styles.alreadyRatedText}>
            Você já avaliou esta aula. Obrigado pelo seu feedback!
          </Text>
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Como foi sua aula?</Text>
      <Text style={styles.subtitle}>
        Sua avaliação ajuda outros alunos e melhora a qualidade do serviço
      </Text>
